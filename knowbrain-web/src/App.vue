<template>
  <div class="app-layout">
    ...
    <main class="main-area">
      <ChatView v-if="activeNav === 'chat'" ref="chatRef" :key="chatKey" />
      <DocBrowseView v-else :space-id="selectedSpaceId" :space-name="selectedSpaceName" />
    </main>
  </div>
</template>
...
import DocBrowseView from './views/DocBrowseView.vue'
...
const selectedSpaceName = computed(() => {
  ...
  const s = spaces.value.find((x: any) => x.id === selectedSpaceId.value)
  return s?.name || ''
})
